...
def generate_launch_description():
    ...
    def launch_setup(context, *args, **kwargs):
        ...
        random_generator_script = os.path.join(pkg_project_bringup, 'launch', 'random_generator_ackerman.py')
        ...
        for i, robot_name in enumerate(robot_names):
            ...
            ackerman_dir = f'limo_ackerman{i+1}'
            sdf_file = os.path.join(pkg_project_description, 'models', ackerman_dir, robot_sdf)
