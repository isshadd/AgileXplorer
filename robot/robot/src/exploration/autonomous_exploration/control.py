...
class navigationControl(Node):
    def __init__(self):
        ...
        self.subscription_map = self.create_subscription(
            OccupancyGrid, 'limo1/map', self.map_callback, 10)
        self.subscription_odom = self.create_subscription(
            Odometry, 'limo1/odom', self.odom_callback, 10)
        ...
        self.subscription_scan = self.create_subscription(
            LaserScan, 'limo1/scan', self.scan_callback, qos_profile)
        ...
        self.move_base_client = ActionClient(self, NavigateToPose, 'limo1/navigate_to_pose')
    ...
    def send_navigation_goal(self, target_position):
        ...
        goal_msg.pose.header.frame_id = "limo1/map"
